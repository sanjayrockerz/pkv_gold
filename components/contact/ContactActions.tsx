...
export function ContactActions({ onAppointment, compact = false }: { onAppointment?: () => void; compact?: boolean }) {
  return <div className={`contact-actions ${compact ? 'contact-actions-compact' : ''}`}>
    ...
    <a className="btn btn-whatsapp" href={buildGeneralWhatsAppUrl()} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp PKV Gold" title="WhatsApp PKV Gold">WHATSAPP PKV GOLD <b>&rarr;</b></a>
