...
export function HeroScrollTransition({ children }: PropsWithChildren) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const statement = root.querySelector<HTMLElement>('.sideStatement');
      ...
      if (!hero || !owner || !copy || !headline || !supporting || !statement || !atmosphere || !overlay || !next) return;
      ...
      if (reducedMotion) {
        ...
        gsap.set(statement, { y: 0, opacity: 1 });
        return;
      }
      ...
      gsap.set(statement, { y: 20, opacity: 0 });
      ...
      entrance
        ...
        .to(statement, { y: 0, opacity: 1, duration: 0.7 }, 0.38);
